...
public class AlchemyAPI {
    ...
    private String _requestUri = "http://gateway-a.watsonplatform.net/calls/";   //"http://access.alchemyapi.com/calls/";
    ...
    { //"image/ImageGetRankedImageKeywords?"
        URL url = new URL(_requestUri + "image/ImageGetRankedImageFaceTags?" +
